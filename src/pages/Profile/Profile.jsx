...
//       dispatch(getUserSavedPosts(id));
//     }
//     console.log("Fetching user posts due to new comment");
//   }, [dispatch, id, post.newComment]);

//   useEffect(() => {
//     if (auth.viewedUser) {
//       setFilteredPosts(post.userPosts);
//       console.log("filtered user posts use effect");
//     }
//   }, [auth.viewedUser, post.userPosts]);

//   // useEffect(() => {
//   //   dispatch(getUsersPostAction());
//   //   console.log("get all post triggered");
//   //   // dispatch(getUserSavedPosts(id));
//   // }, [dispatch, post.newComment]);

//   // useEffect(() => {
//   //   console.log("Updating userPosts state");
